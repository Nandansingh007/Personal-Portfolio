...
<details><summary><b>Personal Portfolio</b> is built using the following technologies:</summary>
...
```bash
git clone https://github.com/Nandansingh007/Personal-Portfolio.git
```
